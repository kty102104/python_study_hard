...
1. for 반복문의 기본 개념
    ...
    예를 들어 지난 시간에 string의 index 개념을 배웠다. string의 경우에는 문자열의 문자 개수만큼
    반복이 진행된다고 해석할 수 있다.
...
'''
# for i in range(1,10,1):     # 종료값이 10인데 1부터 시작해도 9까지 나온다.
#     print(i)                # 종료값 바로 앞까지 출력이 이루어짐.

'''
    2) 문자열을 이용한 반복
        문자열의 경우 []를 이용해 내부에 인덱스 넘버를 명시할 수 있다는 것을 지난 시간에 배웠습니다.
