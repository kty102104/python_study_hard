...
#TODO - 1 : word_list에서 단어를 하나 임의로 선택하고,
# 해당 단어를 chosen_word 라는 변수에 담으세요.
...
# 반복문을 통해 확인할 수 있도록 작성하시오.(반복문과 조건문을 사용해야 함.)

'''
예를 들어 random.choice(word_list)의 결과값이 apple이고, guess에 a를 대입했다면
실행 예
알파벳 입력 >>> a
정답
오답
