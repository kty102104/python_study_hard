...
# satang2.get_info()
'''
이상에서 주목해야 할 점은 satang 인스턴스와 satang2 인스턴스의 생성 방식 차이입니다. -> 한줄 줄였죠.
...
# student3.print_grade()
'''
예제 2. 은행 계좌를 관리하는 BankAccount 클래스를 작성하시오. 이 클래스는 계좌 소유자 이름, 계좌 번호, 잔액을 인스턴스 변수로
    가집니다.
    ...
    4. 계좌 번호를 출력하는 인스턴스 메서드 print_account_info()를 구현하세요. -> 실행 예 참조
